...
public class StartUpAppListener {
	...
	public void contextRefreshedEvent() {
		...
		collaborateurRepository.save(new Collaborateur("Chêne", "Emmanuel", "1995-01-25", "Une adresse", departementRepository.getOne(1)));
		collaborateurRepository.save(new Collaborateur("Ahsène", "Victor", "1996-06-15", "Une adresse", departementRepository.getOne(2)));
	}
}
